...
pair<Vertex<int>*, int> DataLoader::InputBakery(const Graph<int>& graph) {
...
vector<Client * > DataLoader::InputClients(const Graph<int> &graph, int n,const Application &application) {
